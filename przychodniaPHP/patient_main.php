...
<body>
    ...
    <div class="w-100" style=" display: flex; justify-content: center; margin-top: 50px;">
        <div class="w-75" style="flex-direction: column;">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                <div class=" w-100 align-middle jumbotron-extra" >
                    <h5 >Nasze placówki</h5>
                    <hr class="my-1">
                    <p style="margin-top: 20px;">It uses utility classes for typography and spacing to space content out within the larger container.</p>
                </div>
        <div class="jumbotron w-100 align-middle jumbotron-extra" style="display: none;" >
        ...
        <div class="jumbotron w-100 align-middle jumbotron-extra" >
