            ...
            <div style=" display: flex; justify-content: center; margin-top: 50px;">
                <div class="jumbotron w-100 align-middle" style="width:1100px; height: 450px; background-color: rgba(360,360,360,0.5); ">
                    ...
                    <p id="options" class="w-100 " style="text-align: center; padding-top: 20px; ">
                        <a id="registrarRegister " style="font-weight: bolder; padding-right: 20px; font-size: 20px; " href="registrar_register.html">Zarejestruj</a>
                        <a id="registrarShowBill" style="font-weight: bolder; padding-left: 20px; font-size: 20px; " href="registrar_patient_bill.html">Pokaż Rachunek</a>
                    </p>
                </div>
            </div>
