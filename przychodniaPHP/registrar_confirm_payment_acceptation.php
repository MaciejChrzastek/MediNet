        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto nav-fill w-100">
                <li class="nav-item active menu-item">
                    <a class="nav-link" href="registrar_patient_bill.php">
                        Powrót
        ...
        <div class="w-75" style="flex-direction: column;">
            ...
            <div style=" display: flex; justify-content: center; margin-top: 20px;">
                <div class="jumbotron w-100 align-middle" style="width:1100px; height: 450px; background-color: rgba(360,360,360,0.5); ">
                    ...
                    <p class="w-100 " style="text-align: center; font-size: 40px; ">Potwierdź decyzję uznania płatności</p>

                    <p id="options" class="w-100 " style="text-align: center; padding-top: 20px; ">
                        <a id="registrarCancelAcceptPaymentButton" style="font-weight: bolder; font-size: 40px; " href="registrar_patient_bill.php">Anuluj</a>
                        <a id="registrarAcceptPaymentButton" style="font-weight: bolder; font-size: 40px; padding-left: 20px;" href="registrar_payment_confirmed.php">Potwierdzam</a>
                    </p>
                </div>
            </div>
