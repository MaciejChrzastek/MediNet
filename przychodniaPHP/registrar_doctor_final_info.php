...
<body>
    ...
    <div class="w-100" style=" display: flex; justify-content: center; margin-top: 50px; align-items: center;">
        <div class="w-75" style="flex-direction: column;">
            ...
            <?php
                if(isset($_GET['idd'])){
                    $_SESSION['wybrany_lekarz'] = $_GET['idd'];
                    ...
                    <div class="jumbotron w-100 align-middle" style="width:1100px; height: 450px; background-color: rgba(360,360,360,0.5); ">
                        ...
                        <p class="w-100 " style="text-align: center; font-size: 40px; ">Poprawnie wybrano lekarza</p>
    
                        <p id="options_no_error" class="w-100 " style="text-align: center; padding-top: 20px; ">
                            <a id="registrarCorrectDoctorButton" style="font-weight: bolder; font-size: 40px; " href="registrar_register.php">Dalej</a>
                        </p>
                    </div>
                </div>';
                } 
                    ...
                    <div class="jumbotron w-100 align-middle" style="width:1100px; height: 450px; background-color: rgba(360,360,360,0.5); ">
                        ...
                        <p class="w-100 " style="text-align: center; font-size: 40px; ">Nastąpiło niepoprawne wybranie lekarza</p>
    
                        <p id="options_no_error" class="w-100 " style="text-align: center; padding-top: 20px; ">
                            <a id="registrarWringDoctorButton" style="font-weight: bolder; font-size: 40px; " href="registrar_choose_doctor.php">Wróć</a>
                        </p>
                    </div>
                </div>';
                }
